...
import { SuitesCellComponent } from './suites-cell.component';
...
describe('SuitesCellComponent', () => {
  let component: SuitesCellComponent;
  let fixture: ComponentFixture<SuitesCellComponent>;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ SuitesCellComponent ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(SuitesCellComponent);
  ...
  it('call hideTooltip', () => {
   ...
   it('call openDesriredQtyPopup e= 6', fakeAsync(() => {
    component.priceEstimateStoreService.externalConfigReq.configure = [{atoName: 'test',configUIRequest:{payloadId:''}}]
    component.priceEstimateService.openDesriredQtySubject = new Subject();
