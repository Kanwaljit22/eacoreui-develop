...
import { SpnaAssociatedServicesGridComponent } from './spna-associated-services-grid.component';
...
describe('SpnaAssociatedServicesGridComponent', () => {
  let component: SpnaAssociatedServicesGridComponent;
  let fixture: ComponentFixture<SpnaAssociatedServicesGridComponent>;

  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule, HttpClientTestingModule, NgbTooltip],
      declarations: [ SpnaAssociatedServicesGridComponent, LocalizationPipe, DelinkConfirmationComponent ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(SpnaAssociatedServicesGridComponent);
...
it('call goToTroubleShooting', () => {
  component.troubleshootingUrl = 'https://salesconnect.cisco.com/#/content-detail/7baa3606-6d22-453f-bbaf-a8a5dab84666';
  window.open = jest.fn();
