...
describe('EditEnrollmentComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ EditEnrollmentComponent, LocalizationPipe ],
  ...
  it('should set data on ngoninit 1', () => {
    component.eaService.features.COTERM_SEPT_REL = true
    component.selectedEnrollemnt.billingTerm.coterm = {endDate:'0101010101'}
    const billingModalSpy = jest.spyOn(component, 'getBillingModel');
    component.ngOnInit();
    expect(billingModalSpy).toHaveBeenCalled();
    expect(component.selectedBillingModel).toBeTruthy();
  ...
  it('should capitalFrequencySelected', () => {
    const capitalFinance = {}
    component.capitalFrequencySelected(capitalFinance);
    expect(component.showFrequencyDrop).toBe(false);
  });
  it('should capitalFrequencySelected 1', () => {
    const capitalFinance = {}
    component.isChangeSubFlow = true
    component.capitalFrequencySelected(capitalFinance);
    expect(component.showFrequencyDrop).toBe(false);
  });
  it('should capitalFrequencySelected 2', () => {
    const capitalFinance = {}
  ...
  it('should getAndSetChangeSubDetails', () => {
    const data = {
        error: false,
    ...
    jest.spyOn(restService, 'getApiCall').mockReturnValue(of(data))
    component.getAndSetChangeSubDetails('sub123');
    expect(component.selectedDuration).toBeTruthy();
  });
  ...
  it('should call checkDurationsSelected MONTHSCOTERM 1', () => {
    component.eaService.features.COTERM_SEPT_REL = true
    component.durationTypes = {
      MONTHS36: 'MONTHS36',
      MONTHS60: 'MONTHS60',
  ...
  it('should call onDateSelection 1', () => {
    ...
    component.eaStartDate.setHours(0, 0, 0, 0);
    component.isUserClickedOnDateSelection = true
    component.onDateSelection(event);
  });
