...
import { TotalContractValueBreakUpComponent } from './total-contract-value-break-up.component';

describe('TotalContractValueBreakUpComponent', () => {
  let component: TotalContractValueBreakUpComponent;
  let fixture: ComponentFixture<TotalContractValueBreakUpComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ TotalContractValueBreakUpComponent, LocalizationPipe ],
      schemas: [CUSTOM_ELEMENTS_SCHEMA,NO_ERRORS_SCHEMA],
      imports: [HttpClientTestingModule, RouterTestingModule.withRoutes([]),NgbTooltip],
      providers: [PriceEstimateService,PriceEstimateStoreService,VnextService,EaRestService ,VnextStoreService,ProjectStoreService,  LocalizationService, DataIdConstantsService,CurrencyPipe,UtilitiesService,ProposalStoreService],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(TotalContractValueBreakUpComponent);
