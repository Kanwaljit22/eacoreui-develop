...
@Component({
  selector: 'app-spna-total-contract-value-break-up',
  templateUrl: './spna-total-contract-value-break-up.component.html',
  styleUrls: ['./spna-total-contract-value-break-up.component.scss']
})
export class SpnaTotalContractValueBreakUpComponent implements OnInit {
  ...
  constructor(public priceEstimateService: PriceEstimateService, public renderer: Renderer2, public utilitiesService: UtilitiesService,
    public proposalStoreService: ProposalStoreService, public eaService: EaService,
