...
@Component({
  selector: 'app-manage-purchase-adjustment',
  templateUrl: './manage-purchase-adjustment.component.html',
  styleUrls: ['./manage-purchase-adjustment.component.scss']
})
export class ManagePurchaseAdjustmentComponent implements OnInit, OnDestroy {
  showSuites = false;
  showCredits = false;
  showDurations = false;
  rampEligibilityData = []
  ...
  constructor(public priceEstimateService: PriceEstimateService, public proposalStoreService: ProposalStoreService,
    ...
    private eaRestService: EaRestService, public dataIdConstantsService: DataIdConstantsService, public elementIdConstantsService: ElementIdConstantsService,
    public localizationService: LocalizationService, public eaService: EaService, private renderer: Renderer2) { }
