...
@Component({
  selector: 'app-quantity-install-base-break-up',
  templateUrl: './quantity-install-base-break-up.component.html',
  styleUrls: ['./quantity-install-base-break-up.component.scss']
})
export class QuantityInstallBaseBreakUpComponent implements OnInit, OnDestroy {
  @Input() column: string;
  heading: string;
  data = [];
  dnaData = [];
