...
@Component({
  selector: 'app-purchase-adjustment-break-up',
  templateUrl: './purchase-adjustment-break-up.component.html',
  styleUrls: ['./purchase-adjustment-break-up.component.scss']
})
export class PurchaseAdjustmentBreakUpComponent implements OnInit, OnDestroy {
  @Input() column: string;
  heading: string;
  allExpanded = true;
  data = [];
