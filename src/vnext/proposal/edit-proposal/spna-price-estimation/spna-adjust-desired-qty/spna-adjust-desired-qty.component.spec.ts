...
import { SpnaAdjustDesiredQtyComponent } from './spna-adjust-desired-qty.component';
...
import { AdjustDesiredQtyService } from '../../price-estimation/adjust-desired-qty/adjust-desired-qty.service';
...
describe('SpnaAdjustDesiredQtyComponent', () => {
  let component: SpnaAdjustDesiredQtyComponent;
  let fixture: ComponentFixture<SpnaAdjustDesiredQtyComponent>;

  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [ SpnaAdjustDesiredQtyComponent, LocalizationPipe ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(SpnaAdjustDesiredQtyComponent);
