...
@Component({
  selector: 'app-service-purchase-adjustment-break-up',
  templateUrl: './service-purchase-adjustment-break-up.component.html',
  styleUrls: ['./service-purchase-adjustment-break-up.component.scss']
})
export class ServicePurchaseAdjustmentBreakUpComponent implements OnInit, OnDestroy {
  @Input() column: string;
  heading: string;
  data = [];
  showDropMenu = false;
  ...
  constructor(public priceEstimateService: PriceEstimateService, public renderer: Renderer2, public utilitiesService: UtilitiesService, public eaService: EaService,
