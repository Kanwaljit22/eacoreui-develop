...
describe('ProspectsListComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      ...
      imports: [HttpClientModule,  RouterTestingModule.withRoutes([
       { path: "allArchitectureView", redirectTo: "" }])],
  ...
  it('call viewQualificationList', () => {
    ...
    component.viewQualificationList(prospectObj)
    expect(appDataService.userDashboardFLow).toEqual('');
  });
});
