...
@Component({
  selector: 'app-spna-suites-cell',
  templateUrl: './spna-suites-cell.component.html',
  styleUrls: ['./spna-suites-cell.component.scss']
})
export class SpnaSuitesCellComponent implements ICellRendererAngularComp {
  params: any;
